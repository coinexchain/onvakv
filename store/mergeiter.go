...
type cacheMergeIterator struct {
	parent    types.ObjIterator
	cache     types.ObjIterator
	ascending bool
}

var _ types.ObjIterator = (*cacheMergeIterator)(nil)

func newCacheMergeIterator(parent, cache types.ObjIterator, ascending bool) *cacheMergeIterator {
...
// Value implements ObjIterator
func (iter *cacheMergeIterator) ObjValue(ptr *types.Serializable) {
	iter.skipUntilExistsOrInvalid()
	iter.assertValid()
